...
<script type="text/javascript">
	$(function() {
		$('#closeBtn').click(function() { /* 닫기 버튼 누르면 팝업창 숨김 처리 */
			...
			let chkVal = $('input:checkbox[id=notopenToday]:checked').val(); // 체크박스의 체크 여부
...
<body>
	...
	if(cookies != null){
		for(Cookie c : cookies){
			...
			if(cookieName.equals("PopupClose")){ 	// PopClose 쿠키가 존재하면 
				popupMode = cookieValue;			// popupMode의 값이 업데이트
			}
		}
	}
	for (int i = 0; i <= 10; i++) {
	...
	<div id="popup">
		<h2 align="center">앱 다운 받고 사과 시계 울트라 받아가자!</h2>
		<div align="right">
